...
module mysystem_mm_interconnect_1 (
		...
		input  wire        HEX5_HEX4_reset_reset_bridge_in_reset_reset,                      //                      HEX5_HEX4_reset_reset_bridge_in_reset.reset
		...
		output wire [12:0] Control_0_slave_address,                                          //                                            Control_0_slave.address
		output wire        Control_0_slave_write,                                            //                                                           .write
		output wire        Control_0_slave_read,                                             //                                                           .read
		input  wire [31:0] Control_0_slave_readdata,                                         //                                                           .readdata
		output wire [31:0] Control_0_slave_writedata,                                        //                                                           .writedata
		output wire [3:0]  Control_0_slave_byteenable,                                       //                                                           .byteenable
	...
	wire   [29:0] hex5_hex4_s1_agent_m0_address;                         // HEX5_HEX4_s1_agent:m0_address -> HEX5_HEX4_s1_translator:uav_address
	...
	wire  [125:0] hex5_hex4_s1_agent_rf_source_data;                     // HEX5_HEX4_s1_agent:rf_source_data -> HEX5_HEX4_s1_agent_rsp_fifo:in_data
	...
	wire  [125:0] hex5_hex4_s1_agent_rsp_fifo_out_data;                  // HEX5_HEX4_s1_agent_rsp_fifo:out_data -> HEX5_HEX4_s1_agent:rf_sink_data
	...
	wire  [125:0] hex3_hex0_s1_agent_rf_source_data;                     // HEX3_HEX0_s1_agent:rf_source_data -> HEX3_HEX0_s1_agent_rsp_fifo:in_data
	...
	wire  [125:0] hex3_hex0_s1_agent_rsp_fifo_out_data;                  // HEX3_HEX0_s1_agent_rsp_fifo:out_data -> HEX3_HEX0_s1_agent:rf_sink_data
	...
	wire  [125:0] leds_s1_agent_rf_source_data;                          // leds_s1_agent:rf_source_data -> leds_s1_agent_rsp_fifo:in_data
	...
	wire  [125:0] leds_s1_agent_rsp_fifo_out_data;                       // leds_s1_agent_rsp_fifo:out_data -> leds_s1_agent:rf_sink_data
	...
	wire   [29:0] switches_s1_agent_m0_address;                          // switches_s1_agent:m0_address -> switches_s1_translator:uav_address
	...
	wire  [125:0] switches_s1_agent_rf_source_data;                      // switches_s1_agent:rf_source_data -> switches_s1_agent_rsp_fifo:in_data
	...
	wire  [125:0] switches_s1_agent_rsp_fifo_out_data;                   // switches_s1_agent_rsp_fifo:out_data -> switches_s1_agent:rf_sink_data
	...
	wire   [31:0] control_0_slave_agent_m0_readdata;                     // Control_0_slave_translator:uav_readdata -> Control_0_slave_agent:m0_readdata
	wire          control_0_slave_agent_m0_waitrequest;                  // Control_0_slave_translator:uav_waitrequest -> Control_0_slave_agent:m0_waitrequest
	wire          control_0_slave_agent_m0_debugaccess;                  // Control_0_slave_agent:m0_debugaccess -> Control_0_slave_translator:uav_debugaccess
	wire   [29:0] control_0_slave_agent_m0_address;                      // Control_0_slave_agent:m0_address -> Control_0_slave_translator:uav_address
	wire    [3:0] control_0_slave_agent_m0_byteenable;                   // Control_0_slave_agent:m0_byteenable -> Control_0_slave_translator:uav_byteenable
	wire          control_0_slave_agent_m0_read;                         // Control_0_slave_agent:m0_read -> Control_0_slave_translator:uav_read
	wire          control_0_slave_agent_m0_readdatavalid;                // Control_0_slave_translator:uav_readdatavalid -> Control_0_slave_agent:m0_readdatavalid
	wire          control_0_slave_agent_m0_lock;                         // Control_0_slave_agent:m0_lock -> Control_0_slave_translator:uav_lock
	wire   [31:0] control_0_slave_agent_m0_writedata;                    // Control_0_slave_agent:m0_writedata -> Control_0_slave_translator:uav_writedata
	wire          control_0_slave_agent_m0_write;                        // Control_0_slave_agent:m0_write -> Control_0_slave_translator:uav_write
	wire    [2:0] control_0_slave_agent_m0_burstcount;                   // Control_0_slave_agent:m0_burstcount -> Control_0_slave_translator:uav_burstcount
	wire          control_0_slave_agent_rf_source_valid;                 // Control_0_slave_agent:rf_source_valid -> Control_0_slave_agent_rsp_fifo:in_valid
	wire  [125:0] control_0_slave_agent_rf_source_data;                  // Control_0_slave_agent:rf_source_data -> Control_0_slave_agent_rsp_fifo:in_data
	wire          control_0_slave_agent_rf_source_ready;                 // Control_0_slave_agent_rsp_fifo:in_ready -> Control_0_slave_agent:rf_source_ready
	wire          control_0_slave_agent_rf_source_startofpacket;         // Control_0_slave_agent:rf_source_startofpacket -> Control_0_slave_agent_rsp_fifo:in_startofpacket
	wire          control_0_slave_agent_rf_source_endofpacket;           // Control_0_slave_agent:rf_source_endofpacket -> Control_0_slave_agent_rsp_fifo:in_endofpacket
	wire          control_0_slave_agent_rsp_fifo_out_valid;              // Control_0_slave_agent_rsp_fifo:out_valid -> Control_0_slave_agent:rf_sink_valid
	wire  [125:0] control_0_slave_agent_rsp_fifo_out_data;               // Control_0_slave_agent_rsp_fifo:out_data -> Control_0_slave_agent:rf_sink_data
	wire          control_0_slave_agent_rsp_fifo_out_ready;              // Control_0_slave_agent:rf_sink_ready -> Control_0_slave_agent_rsp_fifo:out_ready
	wire          control_0_slave_agent_rsp_fifo_out_startofpacket;      // Control_0_slave_agent_rsp_fifo:out_startofpacket -> Control_0_slave_agent:rf_sink_startofpacket
	wire          control_0_slave_agent_rsp_fifo_out_endofpacket;        // Control_0_slave_agent_rsp_fifo:out_endofpacket -> Control_0_slave_agent:rf_sink_endofpacket
	wire          control_0_slave_agent_rdata_fifo_src_valid;            // Control_0_slave_agent:rdata_fifo_src_valid -> Control_0_slave_agent_rdata_fifo:in_valid
	wire   [33:0] control_0_slave_agent_rdata_fifo_src_data;             // Control_0_slave_agent:rdata_fifo_src_data -> Control_0_slave_agent_rdata_fifo:in_data
	wire          control_0_slave_agent_rdata_fifo_src_ready;            // Control_0_slave_agent_rdata_fifo:in_ready -> Control_0_slave_agent:rdata_fifo_src_ready
	...
	wire          hex5_hex4_s1_agent_rp_valid;                           // HEX5_HEX4_s1_agent:rp_valid -> router_002:sink_valid
	wire  [124:0] hex5_hex4_s1_agent_rp_data;                            // HEX5_HEX4_s1_agent:rp_data -> router_002:sink_data
	wire          hex5_hex4_s1_agent_rp_ready;                           // router_002:sink_ready -> HEX5_HEX4_s1_agent:rp_ready
	wire          hex5_hex4_s1_agent_rp_startofpacket;                   // HEX5_HEX4_s1_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          hex5_hex4_s1_agent_rp_endofpacket;                     // HEX5_HEX4_s1_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire          hex3_hex0_s1_agent_rp_valid;                           // HEX3_HEX0_s1_agent:rp_valid -> router_003:sink_valid
	wire  [124:0] hex3_hex0_s1_agent_rp_data;                            // HEX3_HEX0_s1_agent:rp_data -> router_003:sink_data
	wire          hex3_hex0_s1_agent_rp_ready;                           // router_003:sink_ready -> HEX3_HEX0_s1_agent:rp_ready
	wire          hex3_hex0_s1_agent_rp_startofpacket;                   // HEX3_HEX0_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          hex3_hex0_s1_agent_rp_endofpacket;                     // HEX3_HEX0_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [124:0] leds_s1_agent_rp_data;                                 // leds_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [124:0] switches_s1_agent_rp_data;                             // switches_s1_agent:rp_data -> router_005:sink_data
	...
	wire          control_0_slave_agent_rp_valid;                        // Control_0_slave_agent:rp_valid -> router_006:sink_valid
	wire  [124:0] control_0_slave_agent_rp_data;                         // Control_0_slave_agent:rp_data -> router_006:sink_data
	wire          control_0_slave_agent_rp_ready;                        // router_006:sink_ready -> Control_0_slave_agent:rp_ready
	wire          control_0_slave_agent_rp_startofpacket;                // Control_0_slave_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          control_0_slave_agent_rp_endofpacket;                  // Control_0_slave_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire          cmd_mux_src_valid;                                     // cmd_mux:src_valid -> HEX5_HEX4_s1_burst_adapter:sink0_valid
	wire  [124:0] cmd_mux_src_data;                                      // cmd_mux:src_data -> HEX5_HEX4_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                     // HEX5_HEX4_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [4:0] cmd_mux_src_channel;                                   // cmd_mux:src_channel -> HEX5_HEX4_s1_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                             // cmd_mux:src_startofpacket -> HEX5_HEX4_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                               // cmd_mux:src_endofpacket -> HEX5_HEX4_s1_burst_adapter:sink0_endofpacket
	wire          hex5_hex4_s1_burst_adapter_source0_valid;              // HEX5_HEX4_s1_burst_adapter:source0_valid -> HEX5_HEX4_s1_agent:cp_valid
	wire  [124:0] hex5_hex4_s1_burst_adapter_source0_data;               // HEX5_HEX4_s1_burst_adapter:source0_data -> HEX5_HEX4_s1_agent:cp_data
	...
	wire  [124:0] cmd_mux_001_src_data;                                  // cmd_mux_001:src_data -> HEX3_HEX0_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                 // HEX3_HEX0_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [4:0] cmd_mux_001_src_channel;                               // cmd_mux_001:src_channel -> HEX3_HEX0_s1_burst_adapter:sink0_channel
	...
	wire  [124:0] hex3_hex0_s1_burst_adapter_source0_data;               // HEX3_HEX0_s1_burst_adapter:source0_data -> HEX3_HEX0_s1_agent:cp_data
	...
	wire  [124:0] cmd_mux_002_src_data;                                  // cmd_mux_002:src_data -> leds_s1_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                 // leds_s1_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [4:0] cmd_mux_002_src_channel;                               // cmd_mux_002:src_channel -> leds_s1_burst_adapter:sink0_channel
	...
	wire  [124:0] leds_s1_burst_adapter_source0_data;                    // leds_s1_burst_adapter:source0_data -> leds_s1_agent:cp_data
	...
	wire  [124:0] cmd_mux_003_src_data;                                  // cmd_mux_003:src_data -> switches_s1_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                 // switches_s1_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [4:0] cmd_mux_003_src_channel;                               // cmd_mux_003:src_channel -> switches_s1_burst_adapter:sink0_channel
	...
	wire  [124:0] switches_s1_burst_adapter_source0_data;                // switches_s1_burst_adapter:source0_data -> switches_s1_agent:cp_data
	...
	wire          cmd_mux_004_src_valid;                                 // cmd_mux_004:src_valid -> Control_0_slave_burst_adapter:sink0_valid
	wire  [124:0] cmd_mux_004_src_data;                                  // cmd_mux_004:src_data -> Control_0_slave_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                 // Control_0_slave_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [4:0] cmd_mux_004_src_channel;                               // cmd_mux_004:src_channel -> Control_0_slave_burst_adapter:sink0_channel
	wire          cmd_mux_004_src_startofpacket;                         // cmd_mux_004:src_startofpacket -> Control_0_slave_burst_adapter:sink0_startofpacket
	wire          cmd_mux_004_src_endofpacket;                           // cmd_mux_004:src_endofpacket -> Control_0_slave_burst_adapter:sink0_endofpacket
	wire          control_0_slave_burst_adapter_source0_valid;           // Control_0_slave_burst_adapter:source0_valid -> Control_0_slave_agent:cp_valid
	wire  [124:0] control_0_slave_burst_adapter_source0_data;            // Control_0_slave_burst_adapter:source0_data -> Control_0_slave_agent:cp_data
	wire          control_0_slave_burst_adapter_source0_ready;           // Control_0_slave_agent:cp_ready -> Control_0_slave_burst_adapter:source0_ready
	wire    [4:0] control_0_slave_burst_adapter_source0_channel;         // Control_0_slave_burst_adapter:source0_channel -> Control_0_slave_agent:cp_channel
	wire          control_0_slave_burst_adapter_source0_startofpacket;   // Control_0_slave_burst_adapter:source0_startofpacket -> Control_0_slave_agent:cp_startofpacket
	wire          control_0_slave_burst_adapter_source0_endofpacket;     // Control_0_slave_burst_adapter:source0_endofpacket -> Control_0_slave_agent:cp_endofpacket
	...
	wire          hex5_hex4_s1_agent_rdata_fifo_out_valid;               // HEX5_HEX4_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] hex5_hex4_s1_agent_rdata_fifo_out_data;                // HEX5_HEX4_s1_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          hex5_hex4_s1_agent_rdata_fifo_out_ready;               // avalon_st_adapter:in_0_ready -> HEX5_HEX4_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_out_0_valid;                         // avalon_st_adapter:out_0_valid -> HEX5_HEX4_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                          // avalon_st_adapter:out_0_data -> HEX5_HEX4_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                         // HEX5_HEX4_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                         // avalon_st_adapter:out_0_error -> HEX5_HEX4_s1_agent:rdata_fifo_sink_error
	...
	wire          control_0_slave_agent_rdata_fifo_out_valid;            // Control_0_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] control_0_slave_agent_rdata_fifo_out_data;             // Control_0_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_004:in_0_data
	wire          control_0_slave_agent_rdata_fifo_out_ready;            // avalon_st_adapter_004:in_0_ready -> Control_0_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_004_out_0_valid;                     // avalon_st_adapter_004:out_0_valid -> Control_0_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                      // avalon_st_adapter_004:out_0_data -> Control_0_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                     // Control_0_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                     // avalon_st_adapter_004:out_0_error -> Control_0_slave_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.reset                  (HEX5_HEX4_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) control_0_slave_translator (
		.clk                    (clk_0_clk_clk),                               //                      clk.clk
		.reset                  (HEX5_HEX4_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (control_0_slave_agent_m0_address),            // avalon_universal_slave_0.address
		.uav_burstcount         (control_0_slave_agent_m0_burstcount),         //                         .burstcount
		.uav_read               (control_0_slave_agent_m0_read),               //                         .read
		.uav_write              (control_0_slave_agent_m0_write),              //                         .write
		.uav_waitrequest        (control_0_slave_agent_m0_waitrequest),        //                         .waitrequest
		.uav_readdatavalid      (control_0_slave_agent_m0_readdatavalid),      //                         .readdatavalid
		.uav_byteenable         (control_0_slave_agent_m0_byteenable),         //                         .byteenable
		.uav_readdata           (control_0_slave_agent_m0_readdata),           //                         .readdata
		.uav_writedata          (control_0_slave_agent_m0_writedata),          //                         .writedata
		.uav_lock               (control_0_slave_agent_m0_lock),               //                         .lock
		.uav_debugaccess        (control_0_slave_agent_m0_debugaccess),        //                         .debugaccess
		.av_address             (Control_0_slave_address),                     //      avalon_anti_slave_0.address
		.av_write               (Control_0_slave_write),                       //                         .write
		.av_read                (Control_0_slave_read),                        //                         .read
		.av_readdata            (Control_0_slave_readdata),                    //                         .readdata
		.av_writedata           (Control_0_slave_writedata),                   //                         .writedata
		.av_byteenable          (Control_0_slave_byteenable),                  //                         .byteenable
		.av_begintransfer       (),                                            //              (terminated)
		.av_beginbursttransfer  (),                                            //              (terminated)
		.av_burstcount          (),                                            //              (terminated)
		.av_readdatavalid       (1'b0),                                        //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                    //             clk.clk
		.reset                   (HEX5_HEX4_reset_reset_bridge_in_reset_reset),      //       clk_reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) control_0_slave_agent (
		.clk                     (clk_0_clk_clk),                                       //             clk.clk
		.reset                   (HEX5_HEX4_reset_reset_bridge_in_reset_reset),         //       clk_reset.reset
		.m0_address              (control_0_slave_agent_m0_address),                    //              m0.address
		.m0_burstcount           (control_0_slave_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (control_0_slave_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (control_0_slave_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (control_0_slave_agent_m0_lock),                       //                .lock
		.m0_readdata             (control_0_slave_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (control_0_slave_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (control_0_slave_agent_m0_read),                       //                .read
		.m0_waitrequest          (control_0_slave_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (control_0_slave_agent_m0_writedata),                  //                .writedata
		.m0_write                (control_0_slave_agent_m0_write),                      //                .write
		.rp_endofpacket          (control_0_slave_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (control_0_slave_agent_rp_ready),                      //                .ready
		.rp_valid                (control_0_slave_agent_rp_valid),                      //                .valid
		.rp_data                 (control_0_slave_agent_rp_data),                       //                .data
		.rp_startofpacket        (control_0_slave_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (control_0_slave_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (control_0_slave_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (control_0_slave_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (control_0_slave_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (control_0_slave_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (control_0_slave_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (control_0_slave_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (control_0_slave_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (control_0_slave_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (control_0_slave_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (control_0_slave_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (control_0_slave_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (control_0_slave_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (control_0_slave_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (control_0_slave_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (control_0_slave_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_004_out_0_ready),                   // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_004_out_0_valid),                   //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_004_out_0_data),                    //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_004_out_0_error),                   //                .error
		.rdata_fifo_src_ready    (control_0_slave_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (control_0_slave_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (control_0_slave_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                               //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                 //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) control_0_slave_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                    //       clk.clk
		.reset             (HEX5_HEX4_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
		.in_data           (control_0_slave_agent_rf_source_data),             //        in.data
		.in_valid          (control_0_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (control_0_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (control_0_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (control_0_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (control_0_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (control_0_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (control_0_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (control_0_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (control_0_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                            // (terminated)
		.csr_read          (1'b0),                                             // (terminated)
		.csr_write         (1'b0),                                             // (terminated)
		.csr_readdata      (),                                                 // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) control_0_slave_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                               //       clk.clk
		.reset             (HEX5_HEX4_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (control_0_slave_agent_rdata_fifo_src_data),   //        in.data
		.in_valid          (control_0_slave_agent_rdata_fifo_src_valid),  //          .valid
		.in_ready          (control_0_slave_agent_rdata_fifo_src_ready),  //          .ready
		.out_data          (control_0_slave_agent_rdata_fifo_out_data),   //       out.data
		.out_valid         (control_0_slave_agent_rdata_fifo_out_valid),  //          .valid
		.out_ready         (control_0_slave_agent_rdata_fifo_out_ready),  //          .ready
		.csr_address       (2'b00),                                       // (terminated)
		.csr_read          (1'b0),                                        // (terminated)
		.csr_write         (1'b0),                                        // (terminated)
		.csr_readdata      (),                                            // (terminated)
	...
	mysystem_mm_interconnect_1_router_002 router_006 (
		.sink_ready         (control_0_slave_agent_rp_ready),              //      sink.ready
		.sink_valid         (control_0_slave_agent_rp_valid),              //          .valid
		.sink_data          (control_0_slave_agent_rp_data),               //          .data
		.sink_startofpacket (control_0_slave_agent_rp_startofpacket),      //          .startofpacket
		.sink_endofpacket   (control_0_slave_agent_rp_endofpacket),        //          .endofpacket
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (HEX5_HEX4_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.reset                 (HEX5_HEX4_reset_reset_bridge_in_reset_reset),      // cr0_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (control_0_slave_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (control_0_slave_burst_adapter_source0_data),          //          .data
		.source0_channel       (control_0_slave_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (control_0_slave_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (control_0_slave_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (control_0_slave_burst_adapter_source0_ready)          //          .ready
	);
	...
	mysystem_mm_interconnect_1_avalon_st_adapter #(
		...
		.in_rst_0_reset (HEX5_HEX4_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
	...
	mysystem_mm_interconnect_1_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                               // in_clk_0.clk
		.in_rst_0_reset (HEX5_HEX4_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (control_0_slave_agent_rdata_fifo_out_data),   //     in_0.data
		.in_0_valid     (control_0_slave_agent_rdata_fifo_out_valid),  //         .valid
		.in_0_ready     (control_0_slave_agent_rdata_fifo_out_ready),  //         .ready

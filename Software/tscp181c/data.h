...
// MY ADDED VARS
extern int flip[64]; // Not my var, but they didn't include this
extern void *virtual_base;
extern int fd;
extern int flip_horiz[64];
extern volatile int *Main_Pointer;
extern volatile int *curval;
extern volatile int SW_to_HW_Timer;
extern volatile int HW_to_SW_Timer;
extern volatile int end_HW_to_SW_Timer;
